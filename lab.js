...
lovesCode === true ? console.log("I love to code!"): console.log("Coding has its challenges")
...
amysAge > brittanisAge ? console.log("Amy is older."): amysAge < brittanisAge ? console.log("Brittani is older."): console.log("They are the same age.")
...
amysBirthYear === brittanisBirthYear ? console.log('Amy & Brittani were born in the same year'): console.log('Amy & Brittani were not born in the same year')
...
// temp > 80 + raining = tshirt + umbrella
// 60 < temp < 80 + raining = rain jacket
// temp < 60 + raining = rain jacket + umbrella
...
if(rain === true){
  ...
  if(temperature > 80){
    ...
    console.log("You should wear a t-shirt and jeans")
  } else {
    console.log("You should wear a jacket and jeans")
  }
}
...
changeMyMind === true ? changeMyMind = false: changeMyMind = true
